...
class AdminDefaultController extends BaseController
{
    ...
    public function actionIndex()
    {
        ...
        $groupModel = $this->modelGroupClass ? new $this->modelGroupClass : null;
        ...
        return $this->renderIsAjax('index', compact('dataProvider', 'searchModel', 'groupModel'));
    }
