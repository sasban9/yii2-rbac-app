...
class Role extends AbstractItem
{
    ...
    {
        $condition = (Yii::$app->user->isSuperAdmin or Yii::$app->session->get(AuthHelper::SESSION_PREFIX_ROLES)[0] == 'GroupAdmin' or $showAll) ? [] : ['name' => Yii::$app->session->get(AuthHelper::SESSION_PREFIX_ROLES)];
        // echo "<pre>", print_r(Yii::$app->session->get(AuthHelper::SESSION_PREFIX_ROLES));
        // echo "</pre>";die();
