...
use webvimark\modules\UserManagement\models\rbacDB\Group;
...
class User extends UserIdentity
{
    ...
    {
        return $this->hasMany(Group::className(), ['name' => 'group_name'])
            ->viaTable(Yii::$app->getModule('user-management')->user_group_assignment, ['user_id' => 'id']);
        ...
        // $groups = $this->hasMany(Group::className(), ['id' => $model['group_id']]);
        $groups = static::find()->select('user_groups.*')->joinWith('user_groups')->all();
        // $t = $this->hasOne(Group::className(), ['name' => 'group_name'])
        //     ->viaTable(Yii::$app->getModule('user-management')->user_groups, ['id' => 'group_id']);
        echo '<pre>';
        print_r($groups);
        echo '</pre>';
        die();
        ...
        // return $this->hasMany(Group::className(), ['asd' => 'group_name'])
        //     ->viaTable(Yii::$app->getModule('user-management')->user_groups, ['id' => 'group_id']);
    }
